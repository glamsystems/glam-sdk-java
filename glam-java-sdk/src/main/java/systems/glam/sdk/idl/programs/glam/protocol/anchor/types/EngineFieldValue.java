package systems.glam.sdk.idl.programs.glam.protocol.anchor.types;
...
public sealed interface EngineFieldValue extends RustEnum permits
  ...
  record FeeStructure(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.FeeStructure val) implements BorshEnum, EngineFieldValue {

    public static FeeStructure read(final byte[] _data, final int offset) {
      return new FeeStructure(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.FeeStructure.read(_data, offset));
    }
  ...
  record FeeParams(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.FeeParams val) implements BorshEnum, EngineFieldValue {

    public static FeeParams read(final byte[] _data, final int offset) {
      return new FeeParams(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.FeeParams.read(_data, offset));
    }
  ...
  record AccruedFees(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.AccruedFees val) implements BorshEnum, EngineFieldValue {

    public static AccruedFees read(final byte[] _data, final int offset) {
      return new AccruedFees(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.AccruedFees.read(_data, offset));
    }
  ...
  record NotifyAndSettle(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.NotifyAndSettle val) implements BorshEnum, EngineFieldValue {

    public static NotifyAndSettle read(final byte[] _data, final int offset) {
      return new NotifyAndSettle(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.NotifyAndSettle.read(_data, offset));
    }
  ...
  record OracleConfigs(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.OracleConfigs val) implements BorshEnum, EngineFieldValue {

    public static OracleConfigs read(final byte[] _data, final int offset) {
      return new OracleConfigs(systems.glam.sdk.idl.programs.glam.protocol.anchor.types.OracleConfigs.read(_data, offset));
    }
