...
public final class GlamProtocolProgram {
  ...
  public static List<AccountMeta> stakeAuthorizeKeys(final SolanaAccounts solanaAccounts,
                                                     final PublicKey glamStateKey,
                                                     final PublicKey glamVaultKey,
                                                     final PublicKey glamSignerKey,
  ...
  public static List<AccountMeta> stakeDeactivateKeys(final SolanaAccounts solanaAccounts,
                                                      final PublicKey glamStateKey,
                                                      final PublicKey glamVaultKey,
                                                      final PublicKey glamSignerKey,
                                                      final PublicKey stakeKey) {
  ...
  public static Instruction stakeDeactivate(final AccountMeta invokedGlamProtocolProgramMeta,
                                            ...
                                            final PublicKey glamSignerKey,
                                            final PublicKey stakeKey) {
    final var keys = stakeDeactivateKeys(
      solanaAccounts,
      glamStateKey,
      glamVaultKey,
      glamSignerKey,
    ...
    return stakeDeactivate(invokedGlamProtocolProgramMeta, keys);
  }
  ...
  public static List<AccountMeta> stakeDelegateStakeKeys(final SolanaAccounts solanaAccounts,
                                                         final PublicKey glamStateKey,
                                                         final PublicKey glamVaultKey,
                                                         final PublicKey glamSignerKey,
                                                         final PublicKey stakeKey,
  ...
  public static Instruction stakeDelegateStake(final AccountMeta invokedGlamProtocolProgramMeta,
                                               ...
                                               final PublicKey voteKey,
                                               final PublicKey stakeConfigKey) {
    final var keys = stakeDelegateStakeKeys(
      solanaAccounts,
      glamStateKey,
      glamVaultKey,
      glamSignerKey,
    ...
    return stakeDelegateStake(invokedGlamProtocolProgramMeta, keys);
  }
  ...
  public static List<AccountMeta> stakeInitializeKeys(final SolanaAccounts solanaAccounts,
                                                      final PublicKey glamStateKey,
                                                      final PublicKey glamVaultKey,
                                                      final PublicKey glamSignerKey,
                                                      final PublicKey stakeKey) {
  ...
  public static Instruction stakeInitialize(final AccountMeta invokedGlamProtocolProgramMeta,
                                            ...
                                            final PublicKey glamSignerKey,
                                            final PublicKey stakeKey) {
    final var keys = stakeInitializeKeys(
      solanaAccounts,
      glamStateKey,
      glamVaultKey,
      glamSignerKey,
    ...
    return stakeInitialize(invokedGlamProtocolProgramMeta, keys);
  }
  ...
  public static List<AccountMeta> stakeMergeKeys(final SolanaAccounts solanaAccounts,
                                                 final PublicKey glamStateKey,
                                                 final PublicKey glamVaultKey,
                                                 final PublicKey glamSignerKey,
  ...
  public static Instruction stakeMerge(final AccountMeta invokedGlamProtocolProgramMeta,
    ...
    return stakeMerge(invokedGlamProtocolProgramMeta, keys);
  }
  ...
  public static final Discriminator STAKE_MOVE_DISCRIMINATOR = toDiscriminator(165, 157, 188, 245, 244, 234, 42, 186);

  public static List<AccountMeta> stakeMoveKeys(final SolanaAccounts solanaAccounts,
                                                final PublicKey glamStateKey,
                                                final PublicKey glamVaultKey,
                                                final PublicKey glamSignerKey,
                                                final PublicKey sourceStakeKey,
  ...
  public static Instruction stakeMove(final AccountMeta invokedGlamProtocolProgramMeta,
    ...
    int i = STAKE_MOVE_DISCRIMINATOR.write(_data, 0);
    _data[i] = (byte) (moveStake ? 1 : 0);
    ++i;
  ...
  public record StakeMoveIxData(Discriminator discriminator, boolean moveStake, long lamports) implements Borsh {  
    ...
    public static StakeMoveIxData read(final byte[] _data, final int _offset) {
      ...
      final var discriminator = createAnchorDiscriminator(_data, _offset);
      int i = _offset + discriminator.length();
      final var moveStake = _data[i] == 1;
      ++i;
      final var lamports = getInt64LE(_data, i);
      return new StakeMoveIxData(discriminator, moveStake, lamports);
    }
  ...
  public static List<AccountMeta> stakeSplitKeys(final SolanaAccounts solanaAccounts,
                                                 final PublicKey glamStateKey,
                                                 final PublicKey glamVaultKey,
                                                 final PublicKey glamSignerKey,
                                                 final PublicKey stakeKey,
  ...
  public static List<AccountMeta> stakeWithdrawKeys(final SolanaAccounts solanaAccounts,
                                                    final PublicKey glamStateKey,
                                                    final PublicKey glamVaultKey,
                                                    final PublicKey glamSignerKey,
                                                    final PublicKey stakeKey) {
  ...
  public static Instruction stakeWithdraw(final AccountMeta invokedGlamProtocolProgramMeta,
                                          ...
                                          final PublicKey stakeKey,
                                          final long lamports) {
    final var keys = stakeWithdrawKeys(
      solanaAccounts,
      glamStateKey,
      glamVaultKey,
      glamSignerKey,
