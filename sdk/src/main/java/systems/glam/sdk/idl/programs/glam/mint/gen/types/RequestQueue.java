...
public record RequestQueue(PublicKey _address,
  ...
  public static RequestQueue read(final byte[] _data, final int _offset) {
  ...
  public static RequestQueue read(final PublicKey _address, final byte[] _data, final int _offset) {
