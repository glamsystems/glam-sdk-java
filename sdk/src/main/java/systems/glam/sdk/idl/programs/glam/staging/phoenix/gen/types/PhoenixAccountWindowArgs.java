...
public record PhoenixAccountWindowArgs(int traderPdaIndex,
                                       int subaccountIndex,
  ...
  public static PhoenixAccountWindowArgs read(final byte[] _data, final int _offset) {
    ...
    return new PhoenixAccountWindowArgs(traderPdaIndex,
                                        subaccountIndex,
