...
public final class ExtKaminoProgram {
  ...
  public static final Discriminator LENDING_LIQUIDATE_OBLIGATION_AND_REDEEM_RESERVE_COLLATERAL_V_2_DISCRIMINATOR = toDiscriminator(179, 45, 146, 167, 246, 239, 18, 242);

  public static List<AccountMeta> lendingLiquidateObligationAndRedeemReserveCollateralV2Keys(final AccountMeta invokedExtKaminoProgramMeta,
                                                                                             final SolanaAccounts solanaAccounts,
                                                                                             final PublicKey glamStateKey,
                                                                                             final PublicKey glamVaultKey,
                                                                                             final PublicKey glamSignerKey,
                                                                                             ...
                                                                                             final PublicKey instructionSysvarAccountKey,
                                                                                             final PublicKey collateralObligationFarmUserStateKey,
                                                                                             final PublicKey collateralReserveFarmStateKey,
                                                                                             final PublicKey debtObligationFarmUserStateKey,
                                                                                             final PublicKey debtReserveFarmStateKey,
                                                                                             final PublicKey farmsProgramKey) {
    return List.of(
      createWrite(glamStateKey),
      createWrite(glamVaultKey),
      ...
      createRead(instructionSysvarAccountKey),
      createWrite(requireNonNullElse(collateralObligationFarmUserStateKey, invokedExtKaminoProgramMeta.publicKey())),
      createWrite(requireNonNullElse(collateralReserveFarmStateKey, invokedExtKaminoProgramMeta.publicKey())),
      createWrite(requireNonNullElse(debtObligationFarmUserStateKey, invokedExtKaminoProgramMeta.publicKey())),
      createWrite(requireNonNullElse(debtReserveFarmStateKey, invokedExtKaminoProgramMeta.publicKey())),
      createRead(farmsProgramKey)
    );
  }
  ...
  public static Instruction lendingLiquidateObligationAndRedeemReserveCollateralV2(final AccountMeta invokedExtKaminoProgramMeta,
    ...
    final var keys = lendingLiquidateObligationAndRedeemReserveCollateralV2Keys(
      invokedExtKaminoProgramMeta,
      solanaAccounts,
      glamStateKey,
      glamVaultKey,
      ...
      instructionSysvarAccountKey,
      collateralObligationFarmUserStateKey,
      collateralReserveFarmStateKey,
      debtObligationFarmUserStateKey,
      debtReserveFarmStateKey,
      farmsProgramKey
    );
    return lendingLiquidateObligationAndRedeemReserveCollateralV2(
      invokedExtKaminoProgramMeta,
      keys,
      liquidityAmount,
  ...
  public static Instruction lendingLiquidateObligationAndRedeemReserveCollateralV2(final AccountMeta invokedExtKaminoProgramMeta,
    ...
    int i = LENDING_LIQUIDATE_OBLIGATION_AND_REDEEM_RESERVE_COLLATERAL_V_2_DISCRIMINATOR.write(_data, 0);
    putInt64LE(_data, i, liquidityAmount);
    i += 8;
  ...
  public record LendingLiquidateObligationAndRedeemReserveCollateralV2IxData(Discriminator discriminator,
    ...
    public static LendingLiquidateObligationAndRedeemReserveCollateralV2IxData read(final Instruction instruction) {
      return read(instruction.data(), instruction.offset());
    }
    ...
    public static final int LIQUIDITY_AMOUNT_OFFSET = 8;
    public static final int MIN_ACCEPTABLE_RECEIVED_LIQUIDITY_AMOUNT_OFFSET = 16;
    public static final int MAX_ALLOWED_LTV_OVERRIDE_PERCENT_OFFSET = 24;

    public static LendingLiquidateObligationAndRedeemReserveCollateralV2IxData read(final byte[] _data, final int _offset) {
      if (_data == null || _data.length == 0) {
        return null;
      }
      final var discriminator = createAnchorDiscriminator(_data, _offset);
      ...
      return new LendingLiquidateObligationAndRedeemReserveCollateralV2IxData(discriminator, liquidityAmount, minAcceptableReceivedLiquidityAmount, maxAllowedLtvOverridePercent);
    }
  ...
  public static final Discriminator LENDING_REQUEST_ELEVATION_GROUP_DISCRIMINATOR = toDiscriminator(162, 119, 197, 54, 246, 84, 55, 153);

  public static List<AccountMeta> lendingRequestElevationGroupKeys(final SolanaAccounts solanaAccounts,
                                                                   final PublicKey glamStateKey,
                                                                   final PublicKey glamVaultKey,
                                                                   final PublicKey glamSignerKey,
                                                                   final PublicKey integrationAuthorityKey,
  ...
  public static Instruction lendingRequestElevationGroup(final AccountMeta invokedExtKaminoProgramMeta,
    ...
    final var keys = lendingRequestElevationGroupKeys(
      solanaAccounts,
      glamStateKey,
      glamVaultKey,
      glamSignerKey,
  ...
  public static Instruction lendingRequestElevationGroup(final AccountMeta invokedExtKaminoProgramMeta,
                                                         ...
                                                         final int elevationGroup) {
    final byte[] _data = new byte[9];
    int i = LENDING_REQUEST_ELEVATION_GROUP_DISCRIMINATOR.write(_data, 0);
  ...
  public record LendingRequestElevationGroupIxData(Discriminator discriminator, int elevationGroup) implements SerDe {  
    ...
    public static final int ELEVATION_GROUP_OFFSET = 8;

    public static LendingRequestElevationGroupIxData read(final byte[] _data, final int _offset) {
      if (_data == null || _data.length == 0) {
        return null;
      }
      final var discriminator = createAnchorDiscriminator(_data, _offset);
      ...
      return new LendingRequestElevationGroupIxData(discriminator, elevationGroup);
    }
