...
public record CommitBridgeSessionArgs(byte[] transferId,
  ...
  public static final int PROVIDER_TRANSFER_ID_OFFSET = 32;
  public static final int PROVIDER_EMITTER_OFFSET = 64;
  public static final int PROVIDER_SEQUENCE_OFFSET = 96;

  public static CommitBridgeSessionArgs read(final byte[] _data, final int _offset) {
    ...
    return new CommitBridgeSessionArgs(transferId,
                                       providerTransferId,
                                       providerEmitter,
                                       providerSequence);
  }
