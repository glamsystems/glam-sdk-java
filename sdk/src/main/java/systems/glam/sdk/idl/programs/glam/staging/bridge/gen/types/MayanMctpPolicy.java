...
public record MayanMctpPolicy(WormholeWttRoute[] routes) implements SerDe {

  public static final int ROUTES_OFFSET = 0;

  public static MayanMctpPolicy read(final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    final var routes = SerDeUtil.readVector(4, WormholeWttRoute.class, WormholeWttRoute::read, _data, _offset);
    return new MayanMctpPolicy(routes);
  }
