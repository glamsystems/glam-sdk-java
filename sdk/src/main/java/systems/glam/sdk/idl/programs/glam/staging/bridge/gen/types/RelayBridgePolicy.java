...
public record RelayBridgePolicy(WormholeWttRoute[] routes) implements SerDe {

  public static final int ROUTES_OFFSET = 0;

  public static RelayBridgePolicy read(final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    final var routes = SerDeUtil.readVector(4, WormholeWttRoute.class, WormholeWttRoute::read, _data, _offset);
    return new RelayBridgePolicy(routes);
  }
