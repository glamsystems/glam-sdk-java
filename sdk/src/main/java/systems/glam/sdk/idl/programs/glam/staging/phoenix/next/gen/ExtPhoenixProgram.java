...
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.CancelUpToInstruction;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.DepositFundsInstruction;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.DepositParams;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.MultipleOrderPacket;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.OrderIds;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.OrderPacket;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.PhoenixPolicy;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.RegisterTraderParams;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.TransferCollateralChildToParentInstruction;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.TransferCollateralInstruction;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.WithdrawFundsInstruction;
import systems.glam.sdk.idl.programs.glam.staging.phoenix.next.gen.types.WithdrawParams;
