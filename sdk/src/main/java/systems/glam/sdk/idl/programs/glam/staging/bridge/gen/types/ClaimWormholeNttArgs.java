...
public record ClaimWormholeNttArgs(int providerInstructionCount) implements SerDe {

  public static final int BYTES = 2;

  public static final int PROVIDER_INSTRUCTION_COUNT_OFFSET = 0;

  public static ClaimWormholeNttArgs read(final byte[] _data, final int _offset) {
    if (_data == null || _data.length == 0) {
      return null;
    }
    final var providerInstructionCount = getInt16LE(_data, _offset);
    return new ClaimWormholeNttArgs(providerInstructionCount);
  }
